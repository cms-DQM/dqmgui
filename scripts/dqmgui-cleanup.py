...
def start(directory, cmsswSymlink, threshold, lower_threshold):
    # directory="/home/me/work/SERVICE_WORK_CMS/2_DQM/dqmgui/playground"
...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--threshold', default=0.70, help='Maximum fraction of used space in disk; exceeding .pb files will be removed.')
    parser.add_argument('-l', '--lower_threshold', default=0.5, help='Target fraction of used space in disk; will try to clean up up to this fraction.')
